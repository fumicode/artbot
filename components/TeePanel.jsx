      ...
      return pug`
        .teePanel
          ...
          div(style={position:"absolute", top:"0px", left:"35px"})
            Artwork(artwork=this.props.artwork realWidth="30cm" realHeight="40cm" displayWidth=460 noBorder=noBorder)
      `;
    }
      ...
      return pug`
        .teePanel
          ...
          div(style={position:"absolute", top:(y || 140)+ "px", left:(x || 140)+"px"})
            Artwork(artwork=this.props.artwork realWidth="30cm" realHeight="40cm" displayWidth=(w || 260) noBorder=noBorder)
      `;
